...
final class CheckoutNavigatorTests: XCTestCase {
    ...
    func test_navigateToPaymentMethod_setsPaymentMethodRoute() {
        ...
        // Then
        XCTAssertEqual(coordinator.currentRoute, .paymentMethod(TestData.PaymentMethodTypes.card, .fromPaymentSelection))
    }

    func test_navigateToPaymentMethod_withDirectContext_setsCorrectRoute() {
        // When
        sut.navigateToPaymentMethod(TestData.PaymentMethodTypes.applePay, context: .direct)

        // Then
        XCTAssertEqual(coordinator.currentRoute, .paymentMethod(TestData.PaymentMethodTypes.applePay, .direct))
    }
    ...
    func test_handleOtherPaymentMethods_navigatesToPaymentSelection() {
        ...
        sut.navigateToPaymentMethod(TestData.PaymentMethodTypes.card, context: .direct)
