...
final class DIContainerTests: XCTestCase {
    ...
    func test_createContainer_returnsNewContainer() {
        // When
    ...
    // MARK: - createMockContainer Tests

    func test_createMockContainer_returnsContainer() async {
        // When
        let container = await DIContainer.createMockContainer()
    ...
    /// Helper to compare object identity of protocol types
