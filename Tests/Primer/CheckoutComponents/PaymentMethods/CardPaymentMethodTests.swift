...
final class CardPaymentMethodTests: XCTestCase {
    ...
    // NOTE: test_createView_withoutCardFormScope_returnsNil excluded - relies on scope caching
    // mechanisms that require other PRs to merge first. Will be added when dependencies merge.
