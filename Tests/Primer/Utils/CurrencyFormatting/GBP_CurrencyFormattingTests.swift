//
//  GBP_CurrencyFormattingTests.swift
//
...
class GBP_CurrencyFormattingTests: XCTestCase {
    ...
    let sut = Currency(code: "GBP", decimalDigits: 2)

    func test_zero_gbp_formats_correctly() throws {
    ...
    func test_small_gbp_formats_correctly() throws {
        // Create a result dictionary for each locale
        let results: [String: String] = [
    ...
    func test_normal_gbp_formats_correctly() throws {
        // Create a result dictionary for each locale
        let results: [String: String] = [
    ...
    func test_big_gbp_formats_correctly() throws {
        // Create a result dictionary for each locale
        let results: [String: String] = [
    ...
    func test_huge_gbp_formats_correctly() throws {
        // Create a result dictionary for each locale
        let results: [String: String] = [
