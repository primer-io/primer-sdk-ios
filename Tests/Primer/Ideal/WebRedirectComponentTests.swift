...
final class WebRedirectComponentTests: XCTestCase {
    ...
    func testDidFinishPayment() {
        ...
        let error = PrimerError.failedToCreatePayment(paymentMethodType: PrimerPaymentMethodType.adyenIDeal.rawValue, description: "mock_description")
        mockDelegate.didFinishPayment?(error)
