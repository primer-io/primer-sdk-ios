...
final class StripeAchTokenizationViewModelAsyncTests: XCTestCase {
    ...
    private let order = ClientSession.Order(id: "order_id",
                                            merchantAmount: 1234,
    ...
    private let paymentResponseBody = Response.Body.Payment(id: "id",
    ...
    private let tokenizationResponseBody = Response.Body.Tokenization(analyticsId: "analytics_id",
                                                                      id: "id",
                                                                      isVaulted: false,
