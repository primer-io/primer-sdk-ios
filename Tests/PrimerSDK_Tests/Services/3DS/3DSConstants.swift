...
struct ThreeDSConstants {
    ...
    static let netceteraSDKRef = "3DS_LOA_SDK_NEAG_020100_00143"
    ...
    static let beginAuthResponseStr: String = """
        {
          ...
          "authentication" : {
            ...
            "dsReferenceNumber" : "3ds_ds_provider",
    ...
    static let continueAuthResponseStr = """
        {
          "token" : {
            "paymentInstrumentData" : {
              "binData" : {
            ...
            "tokenType" : "MULTI_USE",
            "token" : "F-GFK_ZBRVy9ahcOMXFFwHwxNjI0MzQ2MTc4",
            "analyticsId" : "7dQUq-rPXIGB3lm42UPDYW4t",
            "paymentInstrumentType" : "PAYMENT_CARD"
          },
          "authentication" : {
            "cryptogram" : "sTepAMGnQtNf8tKA3JFssubbKww=",
            "xid" : null,
            "protocolVersion" : "2.1.0",
          ...
          "resumeToken" : "b120e225-041e-428a-bb7d-c4ea927c0e58"
        }
        """
