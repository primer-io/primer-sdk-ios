...
class CardComponentManagerTests: XCTestCase {
    ...
    func test_card_component_manager_initialization() throws {
        var cardComponentManager = MockCardComponentsManager(clientAccessToken: "not_a_valid_jwt_token", cardnumber: nil)
...
//         paymentFlow: "PREFER_VAULT"
        ...
        cardComponentManager = MockCardComponentsManager(clientAccessToken: clientAccessToken, cardnumber: "4242424242424242")
        XCTAssertEqual(cardComponentManager.decodedClientToken != nil, true)
