...
let mockPaymentMethodConfig = PrimerConfiguration(
    ...
    paymentMethods: [
        ...
        PaymentMethod.Configuration(id: "Apaya", options: PaymentMethod.Apaya.ConfigurationOptions(merchantAccountId: "merchant_account_id"), processorConfigId: nil, type: .apaya)
    ],
    keys: nil
)
...
class MockLocator {
    static func registerDependencies() {
        ...
        DependencyContainer.register(MockTokenizationService(paymentInstrumentType: PaymentMethod.ConfigurationType.paymentCard.rawValue, tokenType: PaymentMethod.TokenType.singleUse.rawValue) as TokenizationServiceProtocol)
