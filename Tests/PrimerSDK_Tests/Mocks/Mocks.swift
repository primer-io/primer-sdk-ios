...
class MockPrimerDelegate: PrimerDelegate {
    ...
    func clientTokenCallback(_ completion: @escaping (String?, Error?) -> Void) {
        ...
        guard let token = token else {
            completion(nil, PrimerInternalError.invalidClientToken(userInfo: ["file": #file, "class": "\(Self.self)", "function": #function, "line": "\(#line)"]))
            return
        }
    ...
    func authorizePayment(_ result: PaymentMethodToken, _ completion: @escaping (Error?) -> Void) {
        ...
        if authorizePaymentFails { completion(PrimerInternalError.invalidClientToken(userInfo: ["file": #file, "class": "\(Self.self)", "function": #function, "line": "\(#line)"])) }
    }
