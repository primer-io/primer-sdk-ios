...
class MockLocator {
    static func registerDependencies() {
        ...
        DependencyContainer.register(MockTokenizationService(paymentInstrumentType: PaymentMethod.ConfigurationType.paymentCard.rawValue, tokenType: TokenType.singleUse.rawValue) as TokenizationServiceProtocol)
