...
final class URLSessionStackTests: XCTestCase {
    ...
    func testAnalyticsReportingForOmitted() {
        ...
        let klarnaCreatePaymentSession = Request.Body.Klarna.CreatePaymentSession(paymentMethodConfigId: "", sessionType: .hostedPaymentPage, localeData: nil, description: nil, redirectUrl: nil, totalAmount: nil, orderItems: nil, attachment: nil)
