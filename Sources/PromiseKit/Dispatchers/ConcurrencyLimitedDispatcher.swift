...
package final class ConcurrencyLimitedDispatcher: Dispatcher {
    ...
    package init(limit: Int, queue: Dispatcher = DispatchQueue.global(qos: .background)) {
        self.queue = queue
        semaphore = DispatchSemaphore(value: limit)
    }

    package convenience init(limit: Int, queue: DispatchQueue) {
