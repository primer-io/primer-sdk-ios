...
@objc
public class PrimerClientSession: NSObject, Codable {
    public let customerId: String?
    public let orderId: String?
    public let currencyCode: String?
...
@objc
public class PrimerOrder: NSObject, Codable {
...
@objc
public class PrimerCustomer: NSObject, Codable {
    public let emailAddress: String?
    public let mobileNumber: String?
    public let firstName: String?
    public let lastName: String?
...
@objc
public class PrimerLineItem: NSObject, Codable {
...
@objc
public class PrimerAddress: NSObject, Codable {
