...
public class Primer {
    ...
    public func showPaymentMethod(_ paymentMethod: PaymentMethodConfigType,
                                  withIntent intent: PrimerSessionIntent,
                                  on viewController: UIViewController,
                                  with clientToken: String? = nil,
                                  completion: ((Error?) -> Void)? = nil)
    {
        if let clientToken = clientToken {
            ...
            .done {
                self.continueShowPaymentMethod(paymentMethod, withIntent: intent, on: viewController, with: clientToken, completion: completion)
            }
            .catch { error in
    ...
    private func continueShowPaymentMethod(_ paymentMethod: PaymentMethodConfigType,
                                           withIntent intent: PrimerSessionIntent,
                                           on viewController: UIViewController,
                                           with clientToken: String? = nil,
                                           completion: ((Error?) -> Void)? = nil)
