...
internal class MockPrimerDelegate: PrimerDelegate {
    ...
    func authorizePayment(_ result: PaymentMethodTokenData, _ completion: @escaping (Error?) -> Void) {

    }
    
    func onTokenizeSuccess(_ paymentMethodToken: PaymentMethodTokenData, _ completion: @escaping (Error?) -> Void) {
