    ...
    public class RawDataManager: NSObject {
        ...
        required public init(paymentMethodType: String) throws {
            ...
            default:
                ...
                self.paymentMethodType = paymentMethodType
                let err = PrimerError.unsupportedPaymentMethod(paymentMethodType: self.paymentMethodType, userInfo: ["file": #file, "class": "\(Self.self)", "function": #function, "line": "\(#line)"], diagnosticsId: nil)
                throw err
            }
        ...
        public func submit() {
            guard let rawData = rawData else {
                let err = PrimerError.invalidValue(key: "rawData", value: nil, userInfo: ["file": #file, "class": "\(Self.self)", "function": #function, "line": "\(#line)"], diagnosticsId: nil)
