...
public protocol PrimerRawDataManagerDelegate {
    func primerRawDataManager(_ primerRawDataManager: PrimerRawDataManager, dataDidChange data: PrimerRawData?)
    func primerRawDataManager(_ primerRawDataManager: PrimerRawDataManager, dataIsValid isValid: Bool)
}

public class PrimerRawDataManager: NSObject {
...
extension PrimerRawDataManager: SFSafariViewControllerDelegate {
