...
struct KlarnaHelpers {
    ...
    // MARK: - Error helpers
    static func getInvalidTokenError() -> PrimerError { handled(primerError: .invalidClientToken()) }
    static func getInvalidSettingError(name: String) -> PrimerError { handled(primerError: .invalidValue(key: name)) }
