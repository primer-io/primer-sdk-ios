...
/// Type alias for Klarna category item customization component.
@available(iOS 15.0, *)
public typealias KlarnaCategoryItemComponent = (any PrimerKlarnaScope, KlarnaPaymentCategory, Bool) -> any View
...
public protocol PrimerKlarnaScope: PrimerPaymentMethodScope where State == KlarnaState {
    ...
    /// Custom category item component.
    var categoryItem: KlarnaCategoryItemComponent? { get set }
}
