...
final class DesignTokensManager: ObservableObject {
  ...
  func radius(
    _ keyPath: KeyPath<DesignTokens, CGFloat>,
    override overrideKeyPath: KeyPath<RadiusOverrides, CGFloat?>? = nil
  ) -> CGFloat {
    if let overrideKeyPath,
  ...
  func spacing(
    _ keyPath: KeyPath<DesignTokens, CGFloat>,
    override overrideKeyPath: KeyPath<SpacingOverrides, CGFloat?>? = nil
  ) -> CGFloat {
    if let overrideKeyPath,
  ...
  func size(
    _ keyPath: KeyPath<DesignTokens, CGFloat>,
    override overrideKeyPath: KeyPath<SizeOverrides, CGFloat?>? = nil
  ) -> CGFloat {
    if let overrideKeyPath,
  ...
  ) -> TypographyOverrides.TypographyStyle? {
    guard let overrideKeyPath,
      let typographyOverrides = themeOverrides?.typography
    else {
      return nil
    }
  ...
  private func mergeDictionaries(_ base: [String: Any], with override: [String: Any]) -> [String:
    Any]
  {
    var merged = base
  ...
  private func resolvePass(_ dict: [String: Any], root: [String: Any], hasUnresolved: inout Bool)
    -> [String: Any]
  {
  ...
  private func resolveFlattenedReferences(in flatDict: [String: Any], source: [String: Any])
    -> [String: Any]
  {
  ...
  private func resolveReferencesInString(
    _ string: String, flatDict: [String: Any], source: [String: Any], hasUnresolved: inout Bool
  ) -> Any {
