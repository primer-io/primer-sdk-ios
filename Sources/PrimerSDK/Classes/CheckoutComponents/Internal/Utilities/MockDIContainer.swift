...
//  Licensed under the MIT License. See LICENSE file in the project root for full license information.
    ...
    public class MockDIContainer: ContainerProtocol {
        ...
        public func register<T>(_: T.Type) -> any RegistrationBuilder<T> {
            fatalError("Not needed for preview mocks")
        }

        public func unregister<T>(_: T.Type, name _: String?) -> Self {
            self
        }
        ...
        public func resolveSync<T>(_ type: T.Type, name _: String?) throws -> T {
        ...
        public func reset<T>(ignoreDependencies _: [T.Type]) async {}
    }
