...
// MARK: - Route-Specific Transition Logic (Updated for CheckoutComponents)
@available(iOS 15.0, *)
internal extension NavigationAnimationConfiguration {
    ...
    /// Determines if transition is forward in the navigation flow (Updated for CheckoutComponents routes)
