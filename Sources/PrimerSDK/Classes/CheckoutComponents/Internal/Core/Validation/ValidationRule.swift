...
public struct RequiredFieldRule: ValidationRule {
  ...
  public init(fieldName: String, errorCode: String? = nil) {
    ...
    self.errorCode =
      errorCode ?? "required-\(fieldName.lowercased().replacingOccurrences(of: " ", with: "-"))"
  }
...
public struct LengthRule: ValidationRule {
  ...
  public init(
    fieldName: String, minLength: Int, maxLength: Int? = nil, errorCodePrefix: String? = nil
  ) {
    self.fieldName = fieldName
    self.minLength = minLength
    self.maxLength = maxLength
    self.errorCodePrefix =
      errorCodePrefix ?? "length-\(fieldName.lowercased().replacingOccurrences(of: " ", with: "-"))"
  }
...
public struct CharacterSetRule: ValidationRule {
  ...
  public init(fieldName: String, allowedCharacterSet: CharacterSet, errorCode: String? = nil) {
    ...
    self.errorCode =
      errorCode
      ?? "invalid-chars-\(fieldName.lowercased().replacingOccurrences(of: " ", with: "-"))"
  }
