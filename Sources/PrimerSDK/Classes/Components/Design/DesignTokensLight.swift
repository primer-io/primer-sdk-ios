...
internal class DesignTokensLight: Decodable {
    ...
    public var primerRadiusMedium: CGFloat? = CGFloat(64.00) * 2.00
    public var primerRadiusSmall: CGFloat? = CGFloat(64.00) * 1.00
    public var primerRadiusLarge: CGFloat? = CGFloat(64.00) * 3.00
    public var primerRadiusXsmall: CGFloat? = CGFloat(64.00) * 0.50
    public var primerRadiusBase: CGFloat? = CGFloat(64.00)
    public var primerTypographyBrand: String? = "Inter"
    public var primerTypographyTitleXlargeFont: String? = "Inter"
    public var primerTypographyTitleXlargeLetterSpacing: CGFloat? = CGFloat(-9.60)
    public var primerTypographyTitleXlargeWeight: CGFloat? = CGFloat(8800.00)
    public var primerTypographyTitleXlargeSize: CGFloat? = CGFloat(384.00)
    public var primerTypographyTitleXlargeLineHeight: CGFloat? = CGFloat(512.00)
    public var primerTypographyTitleLargeFont: String? = "Inter"
    public var primerTypographyTitleLargeLetterSpacing: CGFloat? = CGFloat(-3.20)
    public var primerTypographyTitleLargeWeight: CGFloat? = CGFloat(8800.00)
    public var primerTypographyTitleLargeSize: CGFloat? = CGFloat(256.00)
    public var primerTypographyTitleLargeLineHeight: CGFloat? = CGFloat(320.00)
    public var primerTypographyBodyLargeFont: String? = "Inter"
    public var primerTypographyBodyLargeLetterSpacing: CGFloat? = CGFloat(-3.20)
    public var primerTypographyBodyLargeWeight: CGFloat? = CGFloat(6400.00)
    public var primerTypographyBodyLargeSize: CGFloat? = CGFloat(256.00)
    public var primerTypographyBodyLargeLineHeight: CGFloat? = CGFloat(320.00)
    public var primerTypographyBodyMediumFont: String? = "Inter"
    public var primerTypographyBodyMediumLetterSpacing: CGFloat? = CGFloat(0.00)
    public var primerTypographyBodyMediumWeight: CGFloat? = CGFloat(6400.00)
    public var primerTypographyBodyMediumSize: CGFloat? = CGFloat(224.00)
    public var primerTypographyBodyMediumLineHeight: CGFloat? = CGFloat(320.00)
    public var primerTypographyBodySmallFont: String? = "Inter"
    public var primerTypographyBodySmallLetterSpacing: CGFloat? = CGFloat(0.00)
    public var primerTypographyBodySmallWeight: CGFloat? = CGFloat(6400.00)
    public var primerTypographyBodySmallSize: CGFloat? = CGFloat(192.00)
    public var primerTypographyBodySmallLineHeight: CGFloat? = CGFloat(256.00)
    public var primerSpaceXxsmall: CGFloat? = CGFloat(64.00) * 0.50
    public var primerSpaceXsmall: CGFloat? = CGFloat(64.00) * 1.00
    public var primerSpaceSmall: CGFloat? = CGFloat(64.00) * 2.00
    public var primerSpaceMedium: CGFloat? = CGFloat(64.00) * 3.00
    public var primerSpaceLarge: CGFloat? = CGFloat(64.00) * 4.00
    public var primerSpaceXlarge: CGFloat? = CGFloat(64.00) * 5.00
    public var primerSpaceBase: CGFloat? = CGFloat(64.00)
    public var primerSizeSmall: CGFloat? = CGFloat(64.00) * 4.00
    public var primerSizeMedium: CGFloat? = CGFloat(64.00) * 5.00
    public var primerSizeLarge: CGFloat? = CGFloat(64.00) * 6.00
    public var primerSizeXlarge: CGFloat? = CGFloat(64.00) * 8.00
    public var primerSizeXxlarge: CGFloat? = CGFloat(64.00) * 11.00
    public var primerSizeXxxlarge: CGFloat? = CGFloat(64.00) * 14.00
    public var primerSizeBase: CGFloat? = CGFloat(64.00)
