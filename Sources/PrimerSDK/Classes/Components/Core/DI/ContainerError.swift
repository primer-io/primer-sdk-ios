...
public enum ContainerError: Error, Sendable, LocalizedError {
    ...
    public var recoverySuggestion: String? {
        ...
        case .dependencyNotRegistered:
            return "Register the dependency using container.register(_:) or check the type name and spelling"

        case .circularDependency:
            return "Break the circular dependency by using factories, lazy injection, or restructuring your dependencies"
