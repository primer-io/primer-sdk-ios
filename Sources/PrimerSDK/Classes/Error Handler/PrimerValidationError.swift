...
public enum PrimerValidationError: PrimerErrorProtocol, Encodable, Equatable {
    ...
    public var errorDescription: String? {
        ...
        case .invalidCardType(let message, _, _):
            return "[\(errorId)] \(message)"
        case .invalidBankId:
            return "[\(errorId)] Please provide a valid bank id"
        case .banksNotLoaded:
            return "[\(errorId)] Banks need to be loaded before bank id can be collected."
        }
    }
