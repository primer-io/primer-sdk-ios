...
internal enum PrimerError: PrimerErrorProtocol {
    ...
    case cancelled(paymentMethodType: PrimerPaymentMethodType, userInfo: [String: String]?)
    ...
    case unableToPresentPaymentMethod(paymentMethodType: PrimerPaymentMethodType, userInfo: [String: String]?)
    case unsupportedIntent(intent: PrimerSessionIntent, userInfo: [String: String]?)
    case underlyingErrors(errors: [Error], userInfo: [String: String]?)
    case missingCustomUI(paymentMethod: PrimerPaymentMethodType, userInfo: [String: String]?)
