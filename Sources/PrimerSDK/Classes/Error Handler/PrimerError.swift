...
public enum PrimerError: PrimerErrorProtocol {
    ...
    case failedToOpenAppUsingRedirectUrl(redirectUrl: URL, userInfo: [String: String]?, diagnosticsId: String)
    ...
    public var errorId: String {
        ...
        case .failedToOpenAppUsingRedirectUrl:
            return "failed_to_open_app_using_redirect_url"
        case .unknown:
            return "unknown"
        }
    }
    ...
    public var diagnosticsId: String {
        ...
        case .invalidVaultedPaymentMethodId(_, _, let diagnosticsId):
            return diagnosticsId
        case .failedToOpenAppUsingRedirectUrl(_, _, let diagnosticsId):
            return diagnosticsId
    ...
    var plainDescription: String? {
        ...
        case .failedToOpenAppUsingRedirectUrl(let redirectUrl, _, _):
            return "The url: '\(redirectUrl.absoluteString)' couldn't be opened."
        case .unknown:
    ...
    var info: [String: Any]? {
        ...
        case .generic(_, let userInfo, _),
                ...
                .failedToOpenAppUsingRedirectUrl(_, let userInfo, _),
    ...
    public var recoverySuggestion: String? {
        ...
        case .failedToOpenAppUsingRedirectUrl:
            return "Install the Third Party app and try again."
        case .unknown:
