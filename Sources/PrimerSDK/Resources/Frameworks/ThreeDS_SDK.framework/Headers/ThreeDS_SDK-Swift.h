...
///
- (nonnull instancetype)initWithTransactionID:(NSString * _Nonnull)transactionID errorCode:(NSString * _Nonnull)errorCode errorDescription:(NSString * _Nonnull)errorDescription errorDetail:(NSString * _Nullable)errorDetail OBJC_DESIGNATED_INITIALIZER;
