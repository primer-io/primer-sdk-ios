...
extension CardFormView {
    ...
    private func configureNameTF() {
        ...
        nameTF.textColor = Primer.theme.colorTheme.text1
        nameTF.tintColor = Primer.theme.colorTheme.text1
    ...
    private func configureCardTF() {
        ...
        cardTF.textColor = Primer.theme.colorTheme.text1
        cardTF.tintColor = Primer.theme.colorTheme.text1
        ...
        cardTF.addBorder(
            isFocused: false,
            title: "",
            cornerRadius: Primer.theme.cornerRadiusTheme.textFields,
    ...
    @objc private func onTextFieldEditingDidBegin(_ sender: UITextField) {
        ...
        sender.addBorder(isFocused: true, title: title, cornerRadius: theme.cornerRadiusTheme.textFields, theme: theme.textFieldTheme, color: Primer.theme.colorTheme.tint1,
                         backgroundColor: Primer.theme.colorTheme.main1)
    ...
    private func configureExpTF() {
        ...
        expTF.textColor = Primer.theme.colorTheme.text1
        expTF.tintColor = Primer.theme.colorTheme.text1
...
extension CardFormView {
    ...
    private func setNameTFConstraints() {
        ...
        nameTF.leadingAnchor.constraint(equalTo: leadingAnchor, constant: Primer.theme.layout.safeMargin).isActive = true
        nameTF.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -Primer.theme.layout.safeMargin).isActive = true
    ...
    private func setCardTFConstraints() {
        ...
        cardTF.leadingAnchor.constraint(equalTo: leadingAnchor, constant: Primer.theme.layout.safeMargin).isActive = true
        cardTF.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -Primer.theme.layout.safeMargin).isActive = true
    ...
    private func setExpTFConstraints() {
        ...
        expTF.leadingAnchor.constraint(equalTo: leadingAnchor, constant: Primer.theme.layout.safeMargin).isActive = true
    ...
    private func setCvcTFConstraints() {
        ...
        cvcTF.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -Primer.theme.layout.safeMargin).isActive = true
    ...
    private func setSubmitButtonConstraints() {
        ...
        submitButton.leadingAnchor.constraint(equalTo: leadingAnchor, constant: Primer.theme.layout.safeMargin).isActive = true
        submitButton.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -Primer.theme.layout.safeMargin).isActive = true
    }
}
