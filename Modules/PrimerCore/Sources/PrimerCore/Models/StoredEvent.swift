...
@_spi(PrimerInternal) public enum StoredEvent: Codable {
    ...
    public init?(_ event: any AnalyticsEvent) {
...
extension StoredEvent: Equatable {
    public static func == (lhs: StoredEvent, rhs: StoredEvent) -> Bool {
...
@_spi(PrimerInternal) public extension Array where Element == StoredEvent {
