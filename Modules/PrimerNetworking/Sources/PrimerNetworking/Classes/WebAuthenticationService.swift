...
@_spi(PrimerInternal) public protocol WebAuthenticationService {
...
// MARK: MISSING_TESTS
@_spi(PrimerInternal) public final class DefaultWebAuthenticationService: NSObject, WebAuthenticationService {
