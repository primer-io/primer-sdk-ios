...
@_spi(PrimerInternal) public typealias DispatcherCompletion = (Result<DispatcherResponse, Error>) -> Void

@_spi(PrimerInternal) public protocol RequestDispatcher: Sendable {
...
@_spi(PrimerInternal) public struct DispatcherResponseModel: DispatcherResponse {
...
@_spi(PrimerInternal) public struct ResponseMetadataModel: ResponseMetadata {
...
@_spi(PrimerInternal) public protocol DispatcherResponse {
...
@_spi(PrimerInternal) public protocol URLSessionProtocol: Sendable {
    func dataTask(
...
@_spi(PrimerInternal) extension URLSession: URLSessionProtocol {}

@_spi(PrimerInternal) public final class DefaultRequestDispatcher: Sendable {
...
@_spi(PrimerInternal) extension Task: @retroactive PrimerCancellable {}
