//
//  DisplayMetadataComponents.swift
//
...
public final class BaseColoredURLs: Codable {
    ...
    public let coloredUrlStr: String?
    public let darkUrlStr: String?
    public let lightUrlStr: String?
    ...
    public init?(coloredUrlStr: String?, lightUrlStr: String?, darkUrlStr: String?) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        if coloredUrlStr == nil, lightUrlStr == nil, darkUrlStr == nil {
            throw InternalError.failedToDecode(message: "BaseColoredURLs")
        }
    }
...
public final class BaseColors: Codable {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        if coloredHex == nil, lightHex == nil, darkHex == nil {
            throw InternalError.failedToDecode(message: "BaseColors")
        }
    }
...
public final class BaseBorderWidth: Codable {
    ...
    public let colored: CGFloat?
    public let dark: CGFloat?
    public let light: CGFloat?
    ...
    public init?(colored: CGFloat? = 0, light: CGFloat? = 0, dark: CGFloat? = 0) {
