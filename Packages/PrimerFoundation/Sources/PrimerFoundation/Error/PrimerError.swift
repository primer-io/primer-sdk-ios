...
public enum AnalyticsContextKeys {
    ...
    public static let reasonText = "reasonText"
    public static let errorId = "errorId"
}

public protocol PrimerErrorProtocol: CustomNSError, LocalizedError {
...
public enum PrimerError: PrimerErrorProtocol {
    ...
    case missingPrimerInputElement(inputElementType: String, diagnosticsId: String = .uuid)
